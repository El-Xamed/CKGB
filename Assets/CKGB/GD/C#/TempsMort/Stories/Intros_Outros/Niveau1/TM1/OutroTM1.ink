...
~ Trigger("name")
Ils étaient sur ta tête,<br> la dernière fois que j'ai checké.#Bulle:NimuHautGauche
...
Ils sont parfaits tes 'veuch'.#Bulle:NimuHautDroite

Ok.<br>Et j’ai pas de taches de confiture dans le dos ?#Bulle:MorganBasGauche
~ Trigger("name")
Tu te contortionnes de nouveau pour lui faire observer ta chemise.#Bulle:Narrateur

Mais<bounce>…</bounce> pourquoi t’aurais<br> de la confiture dans le<bounce>…</bounce><br> <shake>Non<shake> ! #Bulle:NimuHautDroite
...
~ Trigger("name")
Prêt à partir, tu tapes successivement tes poches pour t'assurer que tout est bien à sa place <i>(pour la 21ème fois)</i>.#Bulle:Narrateur
