...
~ Trigger("name")
Prêt à partir, tu tapes successivement tes poches pour t'assurer que tout est bien à sa place <i>(pour la 21e fois)</i>.#Bulle:Narrateur
Tu fronces les sourcils.#Bulle:Narrateur
~ Trigger("name")
T’aurais pas vu mes <wave>clés</wave> ?#Bulle:MorganHautauche
~ Trigger("name")
...
Je vais te prêter les miennes, t'inquiète.#Bulle:NimuHautGauche
